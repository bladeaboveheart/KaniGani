...
BEGIN
  ...
  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '上', 'atas', 1, 26, 'Bayangkan tanah (一) dengan tongkat (丨) yang menunjuk ke ATAS — sesuatu yang berada di atas permukaan tanah.', 'Seorang jenderal (じょう — JŌ) selalu berdiri di posisi ATAS panggung.')
    RETURNING id INTO k_atas;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '下', 'bawah', 1, 27, 'Tanah (一) dengan jempol kaki (ト) yang menunjuk ke BAWAH — di bawah tanah.', 'Seekor kuda (か — KA) selalu menunduk ke BAWAH saat makan rumput.')
    RETURNING id INTO k_bawah;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '大', 'besar', 1, 28, 'Orang berdiri dengan tangan dan kaki terbuka lebar — menunjukkan sesuatu yang BESAR.', 'Seekor tai (たい — TAI) adalah ikan BESAR yang terkenal di Jepang.')
    RETURNING id INTO k_besar;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '工', 'konstruksi', 1, 29, 'Dua balok dihubungkan tiang — simbol KONSTRUKSI bangunan.', 'Seorang kontraktor (こう — KŌ) memimpin proyek KONSTRUKSI.')
    RETURNING id INTO k_konstr;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '八', 'delapan', 1, 30, 'Dua sirip (ハ) yang membuka — seperti DELAPAN jari yang membuka.', 'Hatchi (はち — HACHI) adalah anjing setia yang menunggu tuannya — DELAPAN tahun menunggu.')
    RETURNING id INTO k_delapan;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '入', 'masuk', 1, 31, 'Dua kaki yang melangkah — sedang MASUK ke suatu tempat.', 'Seorang biksu (にゅう — NYŪ) harus MASUK ke kuil dengan kaki telanjang.')
    RETURNING id INTO k_masuk;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '山', 'gunung', 1, 32, 'Tiga puncak menjulang — persis siluet sebuah GUNUNG.', 'San (さん — SAN) adalah angka tiga, seperti TIGA puncak GUNUNG.')
    RETURNING id INTO k_gunung;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '口', 'mulut', 1, 33, 'Kotak persegi — bentuk MULUT yang terbuka.', 'Seorang komedian (こう — KŌ) selalu membuka MULUT-nya lebar-lebar.')
    RETURNING id INTO k_mulut;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '九', 'sembilan', 1, 34, 'Bentuk seperti angka 9 — karakter ini berarti SEMBILAN.', 'Seekor kuda (く — KU) memiliki SEMBILAN nyawa.')
    RETURNING id INTO k_sembilan;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '一', 'satu', 1, 35, 'Satu garis horizontal — paling sederhana, berarti SATU.', 'Ichi (いち — ICHI) adalah kata Jepang untuk SATU.')
    RETURNING id INTO k_satu;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '人', 'orang', 1, 36, 'Dua goresan seperti kaki ORANG yang berjalan.', 'Ninja (にん — NIN) adalah ORANG yang bergerak dalam kegelapan.')
    RETURNING id INTO k_orang;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '力', 'kekuatan', 1, 37, 'Lengan berotot — simbol KEKUATAN fisik.', 'Seorang ryoku (りょく — RYOKU) adalah pejuang penuh KEKUATAN.')
    RETURNING id INTO k_kekuatan;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '川', 'sungai', 1, 38, 'Tiga garis mengalir paralel — aliran SUNGAI.', 'Kawah (かわ — KAWA) gunung berapi dialiri aliran seperti SUNGAI.')
    RETURNING id INTO k_sungai;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '七', 'tujuh', 1, 39, 'Seperti angka 7 — berarti TUJUH.', 'Shichi (しち — SHICHI) adalah kata Jepang untuk TUJUH.')
    RETURNING id INTO k_tujuh;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '十', 'sepuluh', 1, 40, 'Salib (十) — dua garis bersilang, berarti SEPULUH.', 'Juru (じゅう — JŪ) bicara kepada SEPULUH muridnya.')
    RETURNING id INTO k_sepuluh;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '三', 'tiga', 1, 41, 'Tiga garis horizontal yang rapi — berarti TIGA.', 'San (さん — SAN) adalah kata Jepang untuk TIGA.')
    RETURNING id INTO k_tiga;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '二', 'dua', 1, 42, 'Dua garis horizontal — berarti DUA.', 'Ni (に — NI) adalah kata Jepang untuk DUA.')
    RETURNING id INTO k_dua;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,reading_mnemonic)
    VALUES ('kanji', '女', 'wanita', 1, 43, 'Goresan yang menggambarkan sosok WANITA yang membungkuk.', 'Jo (じょ — JO) adalah nama perempuan — WANITA.')
  ...
  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '上', 'atas-v', 1, 44, 'Ingat kanji 上 yang berarti atas — dipakai langsung sebagai kata benda: posisi di atas.', 'Kata benda yang merujuk pada posisi atau arah ke atas.')
    RETURNING id INTO v_atas;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '大人', 'orang-dewasa', 1, 45, 'Orang BESAR (大) yang sudah dewasa — kombinasi besar + orang.', 'Kata benda untuk orang dewasa; kontras dengan 子供 (anak-anak).')
    RETURNING id INTO v_orang_dewasa;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '一人', 'sendirian', 1, 46, 'SATU orang (一人) — hanya seorang diri, sendirian.', 'Juga bisa berarti "satu orang" dalam konteks menghitung.')
    RETURNING id INTO v_sendirian;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '人工', 'buatan', 1, 47, 'Karya ORANG (人) dari hasil KONSTRUKSI (工) — sesuatu yang dibuat oleh manusia.', 'Digunakan dalam konteks teknologi buatan manusia, seperti 人工知能 (kecerdasan buatan).')
    RETURNING id INTO v_buatan;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '下', 'bawah-v', 1, 48, 'Kanji 下 yang berarti bawah — dipakai langsung sebagai kata benda posisi di bawah.', 'Kata benda yang merujuk pada posisi atau arah ke bawah.')
    RETURNING id INTO v_bawah;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '大きい', 'besar-i', 1, 49, 'Kanji BESAR (大) dengan akhiran い — menjadi kata sifat yang berarti besar.', 'Kata sifat い-adjective. Lawan kata: 小さい (kecil).')
    RETURNING id INTO v_besar_i;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '八', 'delapan-v', 1, 50, 'Kanji DELAPAN (八) dibaca sendiri sebagai kata angka delapan.', 'Angka 8 dalam bentuk kata benda Jepang asli.')
    RETURNING id INTO v_delapan;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '八つ', 'delapan-hal', 1, 51, 'DELAPAN (八) hal — menggunakan penghitung つ untuk benda umum.', 'Cara menghitung delapan benda menggunakan penghitung asli Jepang.')
    RETURNING id INTO v_delapan_hal;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '入り口', 'pintu-masuk', 1, 52, 'Tempat untuk MASUK (入り) melalui MULUT (口) bangunan — pintu masuk.', 'Kata benda untuk entrance atau pintu masuk gedung, toko, dll.')
    RETURNING id INTO v_pintu_masuk;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '大した', 'hebat', 1, 53, 'Sesuatu yang BESAR (大) dampaknya — dipakai untuk menyatakan kehebatan.', 'Kata sifat na-adjective atau prenominal yang berarti luar biasa / hebat.')
    RETURNING id INTO v_hebat;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '山', 'gunung-v', 1, 54, 'Kanji GUNUNG (山) dibaca sendiri — langsung merujuk ke gunung.', 'Kata benda umum untuk gunung.')
    RETURNING id INTO v_gunung;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '口', 'mulut-v', 1, 55, 'Kanji MULUT (口) dibaca sendiri — bagian wajah untuk berbicara dan makan.', 'Juga dipakai dalam arti kiasan seperti 口 (pembukaan, celah).')
    RETURNING id INTO v_mulut;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', 'ふじ山', 'gunung-fuji', 1, 56, 'GUNUNG (山) Fuji — gunung paling terkenal di Jepang.', 'Nama resmi: 富士山. Simbol nasional Jepang.')
    RETURNING id INTO v_gunung_fuji;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '九', 'sembilan-v', 1, 57, 'Kanji SEMBILAN (九) dibaca sebagai angka sembilan.', 'Angka 9. Bacaan きゅう lebih umum dalam percakapan modern.')
    RETURNING id INTO v_sembilan;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '九つ', 'sembilan-hal', 1, 58, 'SEMBILAN (九) hal — menggunakan penghitung つ untuk benda umum.', 'Cara menghitung sembilan benda menggunakan penghitung asli Jepang.')
    RETURNING id INTO v_sembilan_hal;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '一', 'satu-v', 1, 59, 'Kanji SATU (一) dibaca sendiri — angka satu.', 'Angka 1 dalam bentuk kata benda Jepang asli.')
    RETURNING id INTO v_satu;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '一つ', 'satu-hal', 1, 60, 'SATU (一) hal — penghitung つ untuk benda umum.', 'Cara menghitung satu benda menggunakan penghitung asli Jepang.')
    RETURNING id INTO v_satu_hal;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '人', 'orang-v', 1, 61, 'Kanji ORANG (人) dibaca sendiri — merujuk pada seseorang.', 'Bisa merujuk pada "orang", "manusia", atau "seseorang".')
    RETURNING id INTO v_orang;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '下さい', 'tolong-berikan', 1, 62, 'Bentuk permintaan sopan dari BAWAH (下) — meminta sesuatu dengan rendah hati.', 'Ungkapan permintaan sopan. Sering ditulis ください dalam konteks sopan sehari-hari.')
    RETURNING id INTO v_tolong;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '人口', 'populasi', 1, 63, 'ORANG (人) yang masuk melalui MULUT (口) sensus — jumlah penduduk.', 'Kata benda untuk populasi atau jumlah penduduk suatu wilayah.')
    RETURNING id INTO v_populasi;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '力', 'kekuatan-v', 1, 64, 'Kanji KEKUATAN (力) dibaca sendiri — kekuatan fisik maupun mental.', 'Bisa merujuk pada kekuatan fisik, kemampuan, atau daya.')
    RETURNING id INTO v_kekuatan;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '川', 'sungai-v', 1, 65, 'Kanji SUNGAI (川) dibaca sendiri — merujuk pada sungai.', 'Kata benda umum untuk sungai.')
    RETURNING id INTO v_sungai;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '七', 'tujuh-v', 1, 66, 'Kanji TUJUH (七) dibaca sebagai angka tujuh.', 'Angka 7. Bacaan なな lebih umum dalam percakapan modern.')
    RETURNING id INTO v_tujuh;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '七つ', 'tujuh-hal', 1, 67, 'TUJUH (七) hal — penghitung つ untuk benda umum.', 'Cara menghitung tujuh benda menggunakan penghitung asli Jepang.')
    RETURNING id INTO v_tujuh_hal;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '大きさ', 'ukuran', 1, 68, 'BESAR (大き) dijadikan kata benda dengan akhiran さ — tingkatan atau ukuran kebesaran.', 'Kata benda abstrak yang menyatakan ukuran. Contoh: どのくらいの大きさ (seberapa besar).')
    RETURNING id INTO v_ukuran;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '十', 'sepuluh-v', 1, 69, 'Kanji SEPULUH (十) dibaca sendiri — angka sepuluh.', 'Angka 10 dalam bentuk kata benda Jepang.')
    RETURNING id INTO v_sepuluh;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '三', 'tiga-v', 1, 70, 'Kanji TIGA (三) dibaca sendiri — angka tiga.', 'Angka 3 dalam bentuk kata benda Jepang.')
    RETURNING id INTO v_tiga;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '三人', 'tiga-orang', 1, 71, 'TIGA (三) orang — gabungan kanji tiga dan orang.', 'Kata untuk "tiga orang". Penghitung 人 dipakai khusus untuk manusia.')
    RETURNING id INTO v_tiga_orang;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '三つ', 'tiga-hal', 1, 72, 'TIGA (三) hal — penghitung つ untuk benda umum.', 'Cara menghitung tiga benda menggunakan penghitung asli Jepang.')
    RETURNING id INTO v_tiga_hal;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '入る', 'masuk-v', 1, 73, 'Kata kerja dari kanji MASUK (入) — aksi memasuki suatu tempat.', 'Kata kerja intransitif. Pasangannya: 入れる (memasukkan sesuatu).')
    RETURNING id INTO v_masuk_v;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '上げる', 'mengangkat', 1, 74, 'Dari kanji ATAS (上) — bergerak ke atas, mengangkat sesuatu.', 'Kata kerja transitif. Pasangannya: 上がる (naik sendiri).')
    RETURNING id INTO v_angkat;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '下げる', 'menurunkan', 1, 75, 'Dari kanji BAWAH (下) — bergerak ke bawah, menurunkan sesuatu.', 'Kata kerja transitif. Pasangannya: 下がる (turun sendiri).')
    RETURNING id INTO v_turun;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '二', 'dua-v', 1, 76, 'Kanji DUA (二) dibaca sendiri — angka dua.', 'Angka 2 dalam bentuk kata benda Jepang.')
    RETURNING id INTO v_dua;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '二人', 'dua-orang', 1, 77, 'DUA (二) orang bersama — pasangan atau dua individu.', 'Kata untuk "dua orang". Sering dipakai untuk pasangan.')
    RETURNING id INTO v_dua_orang;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '二つ', 'dua-hal', 1, 78, 'DUA (二) hal — penghitung つ untuk benda umum.', 'Cara menghitung dua benda menggunakan penghitung asli Jepang.')
    RETURNING id INTO v_dua_hal;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '力いっぱい', 'dengan-segenap-tenaga', 1, 79, 'KEKUATAN (力) penuh (いっぱい) — menggunakan seluruh tenaga yang ada.', 'Ungkapan idiomatik yang berarti "sekuat tenaga" atau "sepenuh hati".')
    RETURNING id INTO v_segenap;

  INSERT INTO items (type,character,slug,level,lesson_position,meaning_mnemonic,description)
    VALUES ('vocabulary', '女', 'wanita-v', 1, 80, 'Kanji WANITA (女) dibaca sendiri — merujuk pada perempuan.', 'Kata benda umum untuk wanita atau perempuan.')
